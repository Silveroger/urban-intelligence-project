    ...
    def process_video(
        ...
        while cap.isOpened():
            ...
            if frame_idx % step == 0:
                ...
                if post_to_backend and self.adapter:
                    self.adapter.send_telemetry(telemetry_payload)
                ...
                if run_road_defect or run_waterlogging:
                    ...
                    for d in defects:
                        ...
                        if evt:
                            ...
                            if post_to_backend and self.adapter:
                                self.adapter.send_observation(evt)
                ...
                if run_incident:
                    ...
                    for trk in tracked_vehicles:
                        if trk.is_offending and not trk.plate_info:
                            ...
                            if post_to_backend and self.adapter:
                                self.adapter.send_incident(inc_payload)
