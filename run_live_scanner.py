...
def main():
    ...
    parser.add_argument("--post-backend", action="store_true", help="Post live detections and telemetry to Backend REST API")
    ...
    pipeline = EdgeAIPipeline(bus_id=args.bus_id, weights_path=args.weights, backend_url=args.backend)
